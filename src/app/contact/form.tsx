...
export default function Form() {
  return (
    <section className="flex flex-col items-center gap-8 bg-gray-200 bg-opacity-80 py-16 w-full md:max-w-[60%] md:px-[2rem] mb-[2rem]">
      ...
      <p className="text-gray-600 text-md text-center w-[19rem] md:max-w-md ">
      ...
      >
        <div className="flex flex-col md:flex-row items-center gap-4 w-full px-[5rem] md:px-0">
          <input
            ...
            className="border-b leading-8 outline-none border-black w-full bg-transparent focus:border-b-[var(--primaryColor)] transition-all duration-200"
          />
          <input
            required
            name="email"
